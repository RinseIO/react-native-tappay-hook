...
describe('TappayOOP test(ios)', () => {
  ...
  test('getGooglePayPrime() test', async () => {
    expect(await Tappay.getGooglePayPrime('1', 'TWD')).toBeUndefined();
  });
  ...
  test('getApplePayPrime() test', async () => {
    expect(await Tappay.getApplePayPrime('1')).toMatchObject({
      systemOS,
      tappaySDKVersion: 'mock',
      prime: 'mockPrime',
  ...
  test('getSamsungPayPrime() test', async () => {
    expect(await Tappay.getSamsungPayPrime('1', '0', '0', '1')).toBeUndefined();
  });
  ...
  test('applePayTest not ready', async () => {
